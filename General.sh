...
alias hiddenfiles-show='defaults write com.apple.finder AppleShowAllFiles true; killall Finder'
alias hiddenfiles-hide='defaults write com.apple.finder AppleShowAllFiles false; killall Finder'
